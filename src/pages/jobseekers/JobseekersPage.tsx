...
import { FilterJobseekers } from "./components/FilterJobseekers";
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Browse and review job seeker profiles, shortlist top talent for your
          job openings.
        </p>
      </div>
              ...
              {isLoading ? (
                ...
                jobseekers.map((candidate: Jobseeker) => (
                  <TableRow key={candidate.id}>
                    ...
                    <TableCell>{candidate.applicant_position ?? "-"}</TableCell>
                    ...
                    <TableCell className="text-right">
                      <ViewJobseeker jobseekerId={candidate.id} />
                    </TableCell>
                  </TableRow>
                ))
              )}
